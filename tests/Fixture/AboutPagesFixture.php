...
class AboutPagesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'image' => ['type' => 'string', 'length' => 100, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2022-12-28 06:54:45',
                'modified' => '2022-12-28 06:54:45',
            ],
        ];
        parent::init();
    }
