					...
					<div class="row">
						<div class="col-lg-12 col-md-12">
							<div class="filter_search_opt">
								<a href="javascript:void(0);" onclick="openFilterSearch()">Dashboard<i class="ml-2 ti-menu"></i></a>
							</div>
						</div>
					</div>
								...
								<div class="form-submit">	
									...
									<div class="submit-section">
										<div class="row">
											...
											<div class="form-group col-md-12">
												<label>Email</label>
												<input type="email" class="form-control" placeholder="Enter Your Emailaddress">
											</div>
											
											<div class="form-group col-md-12">
												<label>Mobile Number</label>
												<input type="text" class="form-control" placeholder="Enter Your Mobile Numbers">
											</div>
											<div class="form-group col-md-6">
												<button class="btn btn-black btn-md rounded" type="submit">Save Changes</button>
											</div>
										</div>
									</div>
								</div>
