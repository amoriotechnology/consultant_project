				...
				<div class="container">
					<div class="row">
						<div class="col-lg-12 col-md-12">
							...
							<h2 class="ipt-title text-center">Dashboard</h2>
								...
								<div class="sidebar-widgets">
									<div class="dashboard-navbar">
										...
										<div class="d-navigation">
											<ul>
												<li class="active"><a href="<?php echo $this->Url->build('/users/dashboard'); ?>"><i class="ti-dashboard"></i>Dashboard</a></li>
						...
						<div class="col-lg-9 col-md-12">
							...
							<?php echo $this->Flash->render(); ?>
								...
								<div class="form-submit">	
									<h2 class="text-center mb-3 text-white">Welcome to our Dashboard !</h2>
