				...
				<div class="container">
					<div class="row">
						<div class="col-lg-12 col-md-12">
							...
							<h2 class="ipt-title text-center">Change Password</h2>
									...
									<div class="dashboard-navbar">
										...
										<div class="d-navigation">
											<ul>
												...
												<li><a href="<?php echo $this->Url->build('/users/edit-account'); ?>"><i class="ti-dashboard"></i>Account Information</a></li>
												<li class="active"><a href="<?php echo $this->Url->build('/users/change-password'); ?>"><i class="ti-unlock"></i>Change Password</a></li>
						...
						<div class="col-lg-9 col-md-12">
							...
							<?php echo $this->Flash->render(); ?>
								...
								<div class="form-submit">	
									<h4 class="text-center mb-3 text-white">Change Password</h4>
