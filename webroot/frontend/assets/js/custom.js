$(function() {
	...
	! function(n, e, i, a) {
		n.navigation = function(t, s) {
			...
			u.settings = {};
			var t = (n(t), t);
			n(t).find(".nav-menus-wrapper").prepend("<span class='nav-menus-wrapper-close-button'>X</span>"), n(t).find(".nav-search").length > 0 && n(t).find(".nav-search").find("form").prepend("<span class='nav-search-close-button'>Ã¢Å“â€¢</span>"), u.init = function() {
	...
	// Card's slider
	  ...
	  $carousel
		...
		.magnificPopup({
		  ...
		  tLoading: 'Ãâ€”ÃÂ°ÃÂ³Ã‘â‚¬Ã‘Æ’ÃÂ·ÃÂºÃÂ°...',
		  mainClass: 'mfp-zoom-in mfp-img-mobile',
		  image: {
			verticalFit: true,
			tError: '<a href="%url%">ÃÂ¤ÃÂ¾Ã‘â€šÃÂ¾ #%curr%</a> ÃÂ½ÃÂµ ÃÂ·ÃÂ°ÃÂ³Ã‘â‚¬Ã‘Æ’ÃÂ·ÃÂ¸ÃÂ»ÃÂ¾Ã‘ÂÃ‘Å’.'
		  },
		  gallery: {
			enabled: true,
			navigateByImgClick: true,
			tCounter: '<span class="mfp-counter">%curr% ÃÂ¸ÃÂ· %total%</span>', // markup of counte
